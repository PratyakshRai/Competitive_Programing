...
/*
  -> Small Observations:
         what is the problem , 
         like jab tk increasing order me chal rha hai tb tk to theek hai , right ?
         par jaha decreasing aa gya , waha baat fas jayegi, right? 

         hame waha soch samajh ke 2*n-ai karna hoga ,ki future me kahi dikkat na aa jaye , right? 

         we can use dp here , right ? 
