...
/*
  -> Small Observations:
         so fa  is the minimum sum of the array a 

         we can update 
         ai to 
         ai = ai+1+ai-1 - ai

         it is becomming somthing like 
         a1+a1+..n-1 times a1
         -(n-2 times a2 )
         +a3 +a4+a5+a6+..an+an yes two times 
         now what will be the delta 
         this all minus a1+a2 +a3 ..an

         its like 
         delta =ai-1 + ai+1 -2*ai , rigth  ?
         over all delta =a1+an
