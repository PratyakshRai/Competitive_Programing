...
/*
  -> Small Observations:
         so we have n cells , and we have to color them with ai color
         
         ai color pura use hona chahiye , right ? 
         k consecutive cells me same color nhi hona chahiye 

         we can use queue , but hame kab pta chalega ki value
         same ho rhi hai 
         agar queue ka length k se chhota ho gya tb
