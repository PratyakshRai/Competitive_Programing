...
/*
  -> Small Observations:
         ...
         n dragons are there
         sitting in a circle
         circular thing is there  , right  ? 
         ith dragon is the friend of i+1 and i-1 
        ...
        4 : 5 3  
        ..
        aditionally x and y are also friends 

        what could be the maximum and minimum friend of 
        particular ith dragon : 
        3 and  2 
        if there are n dragons : 
        then n-2 will have 2 friends 
        2 of them will have 3 friends 

        we have to somehow fix some values ,such that we can build 
        that mex , otherwise how we are gonna build this shit  ?
