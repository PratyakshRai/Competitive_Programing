...
/*
  -> Small Observations:
         okay , so minimum aur max 

         kisi do element ko pakadna hai 
         aur unka minimum start me aur maximum end me laga dena hai 

         no of operation to get array sorted , rigth 
         how to do this 
         jo pahale se hi sorted hai 

         okay so there are several cases 

         like jo pahale se hi sorted hai , ham unhe nhi chhedenge ? rigthh
         but does it really matters 
         like if we got 
         6 2 3 4 5 7 1 what do you think how many steps it takes ? 
         how to think to the problem ? 
         like ek baat to clear hai 
         for a particular 
         ith position 
         pahale use end me bhejenge , 
         aur phir actual position par 
