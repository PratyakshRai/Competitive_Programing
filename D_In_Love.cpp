...
/*
  -> Small Observations:
         so there are q queries , we have to answer 

         agar ek bhi non intersecting pair rha to answer yes hoga right 
         okay , the thing is , we have some set of pairs  
         we have to tell wheather any one is intersecting or not  ? 
         how to find that  ? in less time complexity ? 
         koi bhi nya pair aa rha hai ,to kya wo ek bhi non intersecting pair bna payega ? ,how to check that ? 
          
         ab ek pair hai  , a b wo non intersecting kab hoga ? 
         jab us pair ke beech me koi interval na aaye (x,y)
         ya wo kisi ke beech me na aaye , to ham kisi ek kadi ko le sakte hai  ? 
         ki uske beech me koi na aaye  right ? 

         how to solve this ? 
         usse pahale a aur b kisi ke bhi starting aur ending point se 
         match nhi karne chahiye right? 
         ya phir 
         kisi ek a b pair ke liye agar ham ye pta kar paye 
         ki 
         ayesa koi x y exists karta hai jo ki 
         yato x y dono a se chhota ho 
         yato x y dono b se bda ho 
         how to find such pair in less time interval ? 

         but problem ye nhi hai 
         hame pure set ka sochna hai 
         ye jaruri nhi ki naye pair ka hi sooche ? right ? 
         to hame ek function bnana padega jisme bas ye pairs pass kardo 
         aur wo hame yes / no return karega phir ek nya pair add 
         karke wapas se function me daaldo ? 
