...
/*
  -> Small Observations:
         so  i have to check whether i can make the array sorted or not , right ? 
         if the array is sorted, i will chose 0 , right ? 
         i have to make it sorted , right ? 
         agar striclty decreasing order me hai 
         to baat hi kuchh aur ,rigth ? 
         i will choosoe the largest element 

         if it is in one increasing order , and then onedecreasing ? 
         think graph
