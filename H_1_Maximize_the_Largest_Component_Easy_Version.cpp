...
/*
  -> Small Observations:
         dekho minimum answer n ya m hoga right ? 

         ek aur cheej , like maanlo agar ham ek row / column chose kar rhe hai 
         to either usme koi # hona chahiye ya
          usse sta koi # hona chahiye ,right ? 
          so what i can do , 
          i will group all the islands 
          and give them a common name ,
          and store their size in map with their name , rigth 
          and i will make a set for each row and column , right 

          now comes the row / column selection 
          i will select a row / column 
          and check how many element are their in the row '.' and "#"
          or like i can then maintain a prefix typo shit , right ? 
          to har ek row / col 
          ke like 
          mai usrow ko iterate karunga aur uske ek aage wale aur uske ek piche wale 
