...
/*
  -> Small Observations:
         what is the problem ? 
         first let define length 
         so length ka mera matlab 
         ai aur aj  , jo question ke criteria ko satisfy karte ho 
         aur length unke beech ki length hai 

         so the things is agar ham ek length ho remove kare to unke beech ke saare 
         elements remove ho jayenge 
         but how to proceed after that ? 
         ayesa bhi to ho sakta hai ki wo length choose karne se future me jo bhi option bane usse maximum na aaye 
         ayesa bhi ho sakta hai , ek length me 
         kai sare dusare length ke bhi ho , like commom intersection 

         is  there any greedy way for doing this ? 
         how to solve this problem ? 
         like 
         let 2....3..2....4..3.....4
         maan lo 3 wale ka length 10 hai 
         2 wale ka 5
         aur 4 wale ka 6 

         so removing the largest will 
         have nuksaan 
         ham 3 ko na remove karke 
         2 aur 4 wale ko remove kar 
         sakte hai 

         but how should i even things this ? 
         suppose if we take binary search 
         how should i insure , we can take 
         m balls out ? 

         ai<n ? what does this means ? 
         will it help  
