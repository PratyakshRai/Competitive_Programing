...
/*
  -> Small Observations:
         so there is n types of portions 
         potion i can be bought using ci coins  
         any type of portion can we obtained no more than one way 
         ek se aadhik tarika nhi hona chahiye  right?  
         the potion used in mixing will be consumed 
         no postion can we obtained from itself 

         unlimited supply of k type of potion 
         for each i , find out the minimum number of coins she spend to obtain
         the potion of type i next
         bc  question kya hai ?   
         
         
         this is not a normal question 

         sabse pahale sabse minimum cost wale portion ko pakdo , usi madad 
         se kaun se portion bna sakte ho wo dekho 
         phir un portion me pe ao , aur unki madad se aur kaun se 
         portion bna sakte ho wo dekho , right ? 
         but how to do it ? 

         ek baat to pakki hai 
         dfs use karna hoga , but implimentation me dikkat aa rhi hai ;)
