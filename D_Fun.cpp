...
/*
  -> Small Observations:
         we are given two integers  n and x 
         find number of triplets (a,b,c)
         note order matters 
         ...
         hame 2 equation aur teen variable diye gaye hai 

         ek baat to clear hai , ham brute force bhi kar sakte 
         2 equation ki maddad se kya variable reduce kiye ja sakte hai 
         ham  kisi ek variable ki range ko fix kar denge 
         like 
         a ki range 1 se x tk kar denge kyu ki a + b + c <=x hai 

         ab iske baad hame ye dekhna hai 
         b aur c kaise aa rhe hai ? 
         phir hamare pass equation ayengi 
         b<=x-1-c , x-10^6-c<=b 
         aur 
         c<=(n-ab)/(b+a);
