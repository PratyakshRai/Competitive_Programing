...
/*
  -> Small Observations:
         ...
         k is 10^12 so we cant do brute force
         hame let say xth index par ka element btana hai ? right ? 

         let say we have the actual number line 
         jisme se hamne sare 4 appearing remove kar diye to hame 
         xth index mill gya

         ith - sare 4 possible =xth 
         ab xth given hai , sare 4 possible nikal lu 
         to ith mill jayega? right? 
         ab sare 4 kaise nikalu ,like number of numbers in which 
         4 appeared as a digit ? 

         like onces digit par ek hi 4 possible 
         two digit ka rha to 
         4x x4 44
         three
         digit ka rha to 
         4xx x4x xx4
         oh its like selecting the for a particular digit 
         like let say we have four digit number
         hence we will calculate specifically till 
         three digit , right ?
         for three digit ? how many four possible 
         selecting 1 digit in four 
         selecting 2 digit in four 
         selecting 3 digit in four
         its like 2^z -1 where z is from 1 to 3 in this case
         then we have to specifically count for the fourth place digit 
