...
/*
  -> Small Observations:
         first length and then the elements from the sequence 
         what the fuck is this question ? 
         in one operation we can delect any one of the elements from the array

         what is the minimum number of operation so that 
         the whole array is the suquences of beautiful blocks ? 
         i think we have to traverse the array backword right  ? 

         how should  i encapsulate them ? 
         where should i traverse , from front or from back ? 

         what is the problem ? 
         agar backward traverse kar rhe hai to hame future ka nhi pta chal pata hai  

         okay so final attack , ham end se traverse karenge,aur phir 
         do variable rhe ga , ek me jine udana hai ,dusare me jo pahale 
         beatiful block bna chuke hai wo  , right ? 
         wo jisme ham beautiful block ki length store karenge wo ek 
         vector/set hoga 
