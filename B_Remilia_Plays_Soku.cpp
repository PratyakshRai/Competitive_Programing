...
/*
  -> Small Observations:
         ek baat to pakki hai ki less than 3 ke liye to 
         khel khatam hai bhale hi kitna hi k ho ek baari me pakdi jayegi ? right? 
...
void Chal_Ja_Plz() {
    ...
    cout<<min(abs((x>y)?n+y-x:n+x-y),abs(x-y))+k<<endl;
}
