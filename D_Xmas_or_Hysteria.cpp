...
/*
  -> Small Observations:
         so what is the winning condition ,
         after some iteration m elves should have same values aur wo bhi positive ya phir m elves jo bachhe hue hai wo choose ho chuke ho aur baki m-n elves negative ho   , right ?
         so the first thing is agar m =0 hai to kaise solve karenge , right? 
