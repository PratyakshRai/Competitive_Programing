...
/*
  -> Small Observations:
         there should be two non empty subset

         it means lenght should be atleast 2 

         for being interesting there must be at least two 

         ways to split  

         hence total length should be 3 at least 

         ek commom portition hona chaiye jo ki dono  me aye ? right ? 
