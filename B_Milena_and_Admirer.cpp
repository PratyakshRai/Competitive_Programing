...
/*
  -> Small Observations:
         u have an array of length n 
         hame array ko increasig order me bnana hai 
         ek element ko ai let , x , ai-x me tod sakte hai 
         peeche se array ko iterate karenge , jab tk increasing order me hai tb tk theek hai 
         par jaha number bda aa gya 

         ek baat to clear hai ki hame array ko reverse iterate karna hoga 

         let say mujhe ek number ko todna hai to mai koshish ye karunga 
         ki let say mujhe    k ko todna hai to 

         x k y hai is order me 
         x k1 k2 y me toda 

         ab k2 ko y ke close ,like <=y as close , 
         k1 jitna bada ho sake utna theek ? 

         is this idea good ? 
         hame peeche se iterate karte time aage wale number ke baare me bhi soochna hai  


         agar graph ke point of view se dekhe to ,
         hame dikkat waha hai jaga local minima 
         ya local maxima ho 

         agar pahale se hi increasing order me hai to theek hai 


         hame ke element jo ki dikkat de rha hai use aadhe aadhe me todenge 
         jb tk wo criteria na maintain kar de 


         ab ek numeber hai , evern rha ho koi dikkat hi nhi , but if odd 
         then if will break into one even and one odd part 
         ab agar odd part y se bda hua to ek barr aur break karenge 
         ab baat ye hai ki is baar hame 2 ki power add kar ni hai 

         its like getting a tree , isnt it ? 
