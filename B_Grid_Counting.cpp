...
/*
  -> Small Observations:
         so har ek k ke liye excatly ek hi condition ban rhi hai, like 

         lets see what we can choose for k 
         to 
         select k=1 what are the different options: 
