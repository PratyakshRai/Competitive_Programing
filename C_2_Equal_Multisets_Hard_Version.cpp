...
/*
  -> Small Observations:
         at a particular time there will be a window of size k   , right ? 
         let say , if array b in that window has not any any -1 
         then it is sure that all the elements in that windown must be same in both of them , right ? 

         maan lo ki maine wo window bna li iska kya matlab hai sare  -1 utilize ho gye honge within that window 
         to ab jo ane wale elements hai aur jo jane wale elements hai unpar focus karte hai 

         ab jo aa rha hai , wo yato dono array me same ho 
         yato to -1 ke saath aye
