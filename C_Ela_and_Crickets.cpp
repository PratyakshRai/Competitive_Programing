...
/*
  -> Small Observations:
         the thing is , L ke khali wale jagah par nhi jana chahiye , agar waaha par aa gya to impossible hai use lena 
         like 
         |
         |    is 
         |   jagah pe na aaye , right ?  
         |___________
...
void Chal_Ja_Plz() {
    ...
    int R = (r1 == r2 || r1 == r3) ? r1 : r2;
    int C = (c1 == c2 || c1 == c3) ? c1 : c2;
    
    bool is_corner = ((R == 1 || R == n) && (C == 1 || C == n));
