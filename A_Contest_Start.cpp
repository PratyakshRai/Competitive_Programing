...
/*
  -> Small Observations:
         if t<x then the answer is zero , right ?   

         to pahale ye dekhenge ki kitna cover kar sakta hai 
         jo ki hai , t/x , right let say 3 cover karega , to 
         n-3 , tk to 3 3 cover ho jayega , phir 2 1 ayese hoga right ? 
