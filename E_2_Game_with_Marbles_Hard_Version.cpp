...
/*  
    ...
    if alice choose ai , then score will s+ai  , 
    if bob chooses bi   , then score will be s-bi 
     
    ab yaha mujhe samne wale sa nuksaan aur apna fayda bhi krana hai 
    if you choose max of ai+bi , then ?
                      if im alice  , then my goal is to 
                      my fayda and opponent ka nuksaan 
                      if ai+bi is max 
                      then , 
                      either ai is max , or bi is max 
                      in both of the case mera fayda hi hai 
                      ai is max then i will save my heavy loss 
                      if bi is max then i have harder punch on bob , 


                      ye hi sooch na tha bosdike 
