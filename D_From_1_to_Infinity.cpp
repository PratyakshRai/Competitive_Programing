...
void solve() {
    ...
    long long low = 0, high = 1e15, full_nums = 0;
    ...
    long long ans = sum_all_digits(full_nums);
    long long remaining_digits = k - count_digits(full_nums);
    
    if (remaining_digits > 0) {
        string s = to_string(full_nums + 1);
