...
/*
  -> Small Observations:
         n piles of stone 
         the "K" selected , is atmost the size of 
         the smallest pile 
         jade se jade , sabse chhote pile ke no of stones 
         jitni honi chahiye K is atmost size 
         phir sabhi se k no of piles nikal denge

         the first person who is unable to make any move losses 
  ...
  -> Your Attacks:
        ...
        agar continuous rhe , like 1 2 3 4 5 6 , to koi kuch 
        kr hi nhi sakta , right? 
        even n => BOB,otherwise Alice will win 


        but agar jaha mauka milla ? 
        waha alice ya bob , chije change kr sakte hai 

        jaha bhi no continuous hue , waha gadbad ho jayegi ? 

        takhta palat karne ke liye , opposnent  x element ka x-1 option choose karga ? 
        like jaha player haar rha hai , waha ho , agar possible hua to 
        kuchh ayesa choose krega like 1 aajaye opponent ke liye 


        so what is the conclusion ? 
  -> Hints From Code:

        bass yahi aatak gya ki , is cheej ki kya guarantee hai ki 
        jiske paas mauka aayega , wo wahi jeete ga
