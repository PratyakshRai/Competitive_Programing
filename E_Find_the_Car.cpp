...
/*
  -> Small Observations:
         we have a number line 0 to n 
         and k+1 sign board at the points 0 a1 a2 ..ak 
         ak is at the point n 
         we also know when we will reach those signs ai 
         ie in bi time 
         between any two adjacent sign the car travels with 
         constant speed   

         how you have q querries each querry with an integer d
         output how many times it takes to reach 
         the point d rounded down to nearest integer 

         we can calculate the relative time for each gaps 
         then we will maintain prefix , and as the speed is constant 
         we can calculate what is asked , simple 
