...
/*
  -> Small Observations:
         alice pahale chalega, right ? 

         ye log try karenge ki pura pura pile of stone uthale taki koi aur option na bache right ? 
         alice bob ke liye kuchh chhode hi na , right 

         let us take only two number , right  
         x  and  y 
         agar alice ki baari hai pahale , 
         aur usne pura utha liya , to phir agale round me bob pura utha ke jit jayega , right ? 
         but agar alice pura nhi uthata hai , let 
         x-1 and y  then what will bob do 
         ye same situation aagyi alice wali , right ?
  -> Your Attacks:
...
void Chal_Ja_Plz() {
   ...
   int o=0;
   for(int i:a)if(i==1)o++;
    if(o==n){
      if(o%2==0)cout<<"Bob"<<endl;
      else cout<<"Alice"<<endl;
    }else {
      if(o%2==0)cout<<"Alice"<<endl;
      else cout<<"Bob"<<endl;
    }
